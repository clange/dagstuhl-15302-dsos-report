...
\subjclass{\emph{Please refer to \url{http://www.acm.org/about/class/1998/}}. Cite, e.g., as B.3.3 Performance Analysis and Design Aids.} %mandatory
\keywords{\emph{Sample keywords related to Dagstuhl Seminar 15302}} %mandatory
...
\begin{abstract}
This report documents the program and the outcomes of Dagstuhl Seminar 15302 ``Perspectives Workshop: Digital Scholarship and Open Science in Psychology and the Behavioral Sciences''.\todo{write more}
\end{abstract}
%------------------------------------------------------------------------
...
%-------------------------------------------------------
%\newpage
\abstracttitle{Open Science and Digital Scholarship at Elsevier}
...
ZPID, the Leibniz Institute for Psychology Information, is a research support organization in the field of psychology, focusing on the German-speaking countries.
ZPID generally aims at supporting scholarly communication from ideas to data collection, data analysis, informal communication, publishing, to finally the discovery of published results via bibliographic databases, giving rise to new ideas.
Recent initiatives particularly focus on making research results, including publications as well as data, accessible to other psychologists, to avoid the waste of research money by redoing studies that exist already, and to improve replicability.
In particular, the ZPID's PsychData service encourages and enables psychologists to share data, and the PsychOpen open access publishing service provides innovations such as multilingual publishing for the European community and the extraction of rich metadata from articles and supplemental material.
It is planned to extend PsychOpen using semantic technology, enabling, e.g., concept-based queries.
Further ZPID services include the PubPsych information retrieval system and the PsychAuthors author profiles database.
