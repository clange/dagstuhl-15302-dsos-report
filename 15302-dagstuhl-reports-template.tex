...
umbrella terms for the movement to make scientific research, its tools and data and
...
culture. An impressive digital infrastructure has been built; this allows us
to correlate information from genomes to diseases, and, by doing so, to support
movements such as panomic studies and personalized medicine. A high degree of interdisciplinary work was necessary in
...
\abstractauthor[ Caroline Jay ]{Caroline Jay (University of Manchester, UK)}
\license
...
\abstractauthor[ Robert Stevens ]{Robert Stevens (University of Manchester, UK)}
\license
%\abstractref[]{} % [] - URL, {} - reference description (a la thebibliography)
%\abstractrefurl{} % preferrably DOI-based URL
